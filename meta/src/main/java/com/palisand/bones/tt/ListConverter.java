...
public class ListConverter implements Converter<List<?>> {
  ...
  @Override
  public List<?> fromTypedText(Parser parser, BufferedReader in, Class<?> cls, Class<?> context,
  ...
  @Override
  public void toTypedText(Repository repository, List<?> obj, PrintWriter out, Class<?> context,
      String margin) throws IOException {
    out.println();
    ...
    for (Object value : list) {
      if (value == null) {
        System.err.println("list in context " + context.getName() + " container null value " + obj
            + " will be ignored");
      } else {
        out.print(margin);
        out.print("-");
