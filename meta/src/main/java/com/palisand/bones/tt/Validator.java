...
public class Validator {
	...
	public void assertNotNull(String field, Object value) {
		if (value == null) {
			violations.add(new ConstraintViolation(Severity.ERROR,node,field,"Field " + field + " should not be null",null));
		}
	}
	
	public void assertNull(String field, Object value) {
    if (value != null) {
      violations.add(new ConstraintViolation(Severity.ERROR,node,field,"Field " + field + " should null",null));
    }
	}
  ...
  public void addViolation(String field, Exception exception) {
    violations.add(new ConstraintViolation(Severity.ERROR,node, field, exception.toString(),exception));
  }
